...
; This track uses the System V AMD64 ABI calling convention and the six first integers 
;'arguments are passed to a function in registers. They are passed in the following order: 
...
max_number_of_boxes:
    ...
    ; Clear the register for division
    mov edx, 0

    ; Move dividend into register for division, then divide
    mov eax, TRUCK_INTERIOR_HEIGHT
    idiv edi; first parameter
